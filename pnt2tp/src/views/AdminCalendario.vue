...
<div class="panel-admin" style="background: #0f172a; color: white; padding: 20px; border-radius: 12px; margin-bottom: 24px; border: 1.5px solid #10b981;">
    ...
    <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
      ...
      <div style="align-self: flex-end; display: flex; gap: 8px;">
        <button 
          @click="estaticoStore.actualizarFechaAdmin(new Date())" 
          style="padding: 8px 14px; border-radius: 8px; background: #334155; color: white; border: none; cursor: pointer; font-weight: 500;"
        >
          ⏰ Resetear a Hoy
        </button>
        
        <!-- Accesos rápidos para probar flujos del fixture -->
        <button 
          @click="estaticoStore.actualizarFechaAdmin('2026-06-11T16:00')" 
          style="padding: 8px 14px; border-radius: 8px; background: #2563eb; color: white; border: none; cursor: pointer; font-weight: 500;"
        >
          ⚽ Fase de Grupos
        </button>
      </div>
